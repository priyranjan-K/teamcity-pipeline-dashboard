...
* The original package name 'au.com.example.teamcity-pipeline-dashboard' is invalid and this project uses 'au.com.example.teamcity_pipeline_dashboard' instead.
